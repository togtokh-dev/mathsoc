													...
													<div class="row">
														...
														<div class="col-xl-7 my-2">
															...
															<div class="form-group row">
																...
																<div class="col-9">
																		<a href="" class="btn btn-primary"><i class="flaticon-facebook-letter-logo"></i>Фэйсбүүк холбох</a>
																</div>
															</div>
															<div class="form-group row">
														...
														<div class="row">
															...
															<div class="col-xl-7">
																...
																<div class="row">
																	<label class="col-3"></label>
																	<div class="col-9">
																		<h6 class="text-dark font-weight-bold mb-10">Нууц үг солих :</h6>
																	</div>
																</div>
																<!--end::Row-->
																<!--begin::Group-->
																<div class="form-group row">
																	<label class="col-form-label col-3 text-lg-right text-left">Хууцчин нууц үг :</label>
																	<div class="col-9">
																		<input class="form-control form-control-lg form-control-solid mb-1" type="text" value="">
																	</div>
																</div>
																<!--end::Group-->
																<!--begin::Group-->
														...
														<div class="row">
															...
															<div class="col-xl-7">
																<div class="row">
																	<div class="col-3"></div>
																	<div class="col-9">
																		<a href="#" class="btn btn-light-primary font-weight-bold">Шинэчлэх</a>
																		<a href="#" class="btn btn-clean font-weight-bold">Болих</a>
																	</div>
																</div>
															</div>
														</div>
