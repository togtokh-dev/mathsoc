							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Сэтгүүл</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
    ...
    document.getElementById("footer_date").innerHTML = d.getFullYear()+" ©";
		$(document).ready(function(){
		    ...
		    $(document).on('click', '#btn_add', function(){
		        ...
		        var name = $('#name').text();
		        var body = $('#body').text();
		        var add_row = $('#add_row').text();
		        if(img == '' && url =='' && name== '' && body=='' && add_row =='' )
		        {
		            Swal.fire("Алдаа", "Хоосон хэсэг байна", "error");
		            return false;
		        }
		        $.ajax({
		            url:"members/insert.php",
		            method:"POST",
		            data:{img:img, url:url ,name:name,body:body,add_row:add_row},
		            dataType:"text",
		            success:function(data)
		            {
									  Swal.fire("Амжилттай", data, "success");
		                fetch_data();
		            }
		        })
		    });
		  ...
		  function edit_data(id, text, column_name)
		    ...
		    $(document).on('blur', '.name', function(){
		        ...
		        edit_data(id,order_in_money, "name");
		    });
		    $(document).on('blur', '.img_in', function(){
		        var id = $(this).data("id");
		        var order_in_money = $(this).text();
		        edit_data(id,order_in_money, "img");
		    });
		    $(document).on('blur', '.url', function(){
		        var id = $(this).data("id");
		        var order_in_money = $(this).text();
		        edit_data(id,order_in_money, "url");
		    });
		    $(document).on('blur', '.body_in', function(){
		        var id = $(this).data("id");
		        var order_in_money = $(this).text();
		        edit_data(id,order_in_money, "body");
		    });
		    $(document).on('blur', '.add_row', function(){
		        var id = $(this).data("id");
		        var order_in_money = $(this).text();
		        edit_data(id,order_in_money, "add_row");
		    });
		    $(document).on('click', '.btn_delete', function(){
		        var id=$(this).data("id");
		        if(confirm("Үнхээр устгах уу?"))
		        {
		            $.ajax({
		                url:"members/delete.php",
		                method:"POST",
		                data:{id:id},
		                dataType:"text",
		                success:function(data){
											 Swal.fire("Амжилттай", data, "info");
		                    fetch_data();
		                }
		            });
		        }
