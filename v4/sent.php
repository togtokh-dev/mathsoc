...
<!DOCTYPE html>
<html lang="en"><base href="<?php if(isset($_GET['id'])){ echo "../";} ?>">
	<!--begin::Head-->
	<head><base href="">
		<meta charset="utf-8" />
              ...
              <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                  ...
                  <div class="d-flex flex-column">
                    <!--begin::Title-->
                    <h2 class="text-white font-weight-bold my-2 mr-5">Хариу илгээх</h2>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <div class="d-flex align-items-center font-weight-bold my-2">
                      <!--begin::Item-->
                      <a href="<?php echo $actual_link; ?>" class="opacity-75 hover-opacity-100">
                        <i class="flaticon2-shelter text-white icon-1x"></i>
                      </a>
                      <!--end::Item-->
                      <!--begin::Item-->
                      <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                      <a href="<?php echo $actual_link; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Хариу илгээх</a>
                      <!--end::Item-->
                      <!--begin::Item-->
                      <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                      <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Сүүлийн бодлогийн илгээлт болон төслийн илгээлт</a>
                      <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                  </div>
                    ...
                    <?php if(isset($_GET['id'])){ ?>
                      ...
                      $id_s=$_GET['id'];
                            if(isset($_POST['sent_file'])){
                              $bio = $_POST['file'];
                                $sql = "INSERT INTO sent_math (bod_id, user_id, file_url, tdate) VALUES ('$id_s', '$user_id','$bio','$time_short')";
                                mysqli_query($db, $sql);
                            }

                           $math_row = mysqli_query($db, "SELECT * FROM math_7 WHERE id='$id_s' LIMIT 1");
                      ...
                      <div class="card card-custom mb-5">
                        ...
                        <div class="card-footer">
                          <form class="" action="math/<?php echo $id_s;  ?>" method="post">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Файлын зам</label>
                            <input type="url" class="form-control" id="exampleInputPassword1" name="file" placeholder="Файлын зам">
                          </div>
                          <input  type="submit" name="sent_file" class="btn btn-primary mr-2" value="Илгээх">
                          </form>
                    ...
                    <div class="card card-custom ">
                      <div class="card-body">
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                          ...
                          <tbody>
                            <?php $orders = mysqli_query($db, "SELECT * FROM sent_math WHERE user_id='$user_id'");
                            $t=1;
                           ?>
                           <?php while ($row = mysqli_fetch_array($orders)) {  ?>
                            <tr>
                              <td><?php echo $t; $t++;?></td>
                              <td><?php echo $row['bod_id'] ?></td>
