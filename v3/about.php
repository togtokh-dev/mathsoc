												 ...
												 <div class="example-preview">
													 <div class="center-text text-center p-5">
														 <a class="btn btn-light-warning font-weight-bold " >
	 															<span class="nav-text">SULD UNITED LLC</span>
 															</a>
													 </div>
															...
															<div class="tab-content mt-5" id="myTabContent3">
																<div class="tab-pane fade active show" id="home-3" role="tabpanel" aria-labelledby="home-tab-3"><p><strong>
																	...
																	<p>• <?php print_r( $lang[$lan]['about_page']['company_in'][0][1]); ?></p>
																	<p>• <?php print_r( $lang[$lan]['about_page']['company_in'][0][2]); ?></p>
																</strong></p></div>
																...
																<div class="tab-pane fade" id="contact-3" role="tabpanel" aria-labelledby="contact-tab-3"><p><strong>
																	<p>• <?php print_r( $lang[$lan]['about_page']['company_in'][3][0]); ?></p>
																	<p>• <?php print_r( $lang[$lan]['about_page']['company_in'][3][1]); ?></p>
																	<p>• <?php print_r( $lang[$lan]['about_page']['company_in'][3][2]); ?></p>
																</strong></p></div>
															</div>
														</div>
										   </div>
												     ...
												     <div class="timeline-items">
												         <div class="timeline-item timeline-item-left">
												             ...
												             <div class="timeline-label">
												                 <span class="text-primary font-weight-bold text-success" >2020 </span>
												             </div>
												         ...
												         <div class="timeline-item timeline-item-right">
												             ...
												             <div class="timeline-label text-primary">
												                 <span class="text-primary font-weight-bold text-success">2019</span>
												             </div>
												             <div class="timeline-content">
												         ...
												         <div class="timeline-item timeline-item-left">
												             ...
												             <div class="timeline-label">
												                 <span class="text-primary font-weight-bold text-success">2018</span>
												             </div>
												             <div class="timeline-content">
																			 <?php print_r( $lang[$lan]['about_page']['c_time_line_in'][2]); ?>
												             </div>
												         </div>
																 <div class="timeline-item timeline-item-right">
												             <div class="timeline-badge">
												                <i class="icon-xl fas fa-unlock text-warning"></i>
												             </div>
												             <div class="timeline-label text-primary">
												                 <span class="text-primary font-weight-bold text-success">2017 </span>
												             </div>
												             <div class="timeline-content">
																			 	<?php print_r( $lang[$lan]['about_page']['c_time_line_in'][3]); ?>
												             </div>
												         </div>
																 <div class="timeline-item timeline-item-left">
												             <div class="timeline-badge">
												                 <i class="icon-xl fas fa-tools text-warning"></i>
												             </div>
												             <div class="timeline-label text-primary">
												                 <span class="text-primary font-weight-bold text-success">2016</span>
												             </div>
												             <div class="timeline-content">
																			 	<?php print_r( $lang[$lan]['about_page']['c_time_line_in'][4]); ?>
												             </div>
												         </div>
																 <div class="timeline-item timeline-item-right">
												             <div class="timeline-badge">
												                <i class="icon-xl la la-store-alt text-warning"></i>
												             </div>
												             <div class="timeline-label text-primary">
												                 <span class="text-primary font-weight-bold text-success">2011</span>
												             </div>
												             <div class="timeline-content">
																	 		 	<?php print_r( $lang[$lan]['about_page']['c_time_line_in'][5]); ?>
												             </div>
												         </div>
																 <div class="timeline-item timeline-item-left">
												             <div class="timeline-badge">
												                 <i class="icon-xl far fa-play-circle text-warning"></i>
												             </div>
												             <div class="timeline-label text-primary">
												                 <span class="text-primary font-weight-bold text-success">2008</span>
												             </div>
												             <div class="timeline-content">
																			 <?php print_r( $lang[$lan]['about_page']['c_time_line_in'][6]); ?>
												             </div>
												         </div>
												     </div>
												 </div>
