...
<html lang="en">
			...
			<div class="d-flex flex-row flex-column-fluid page">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Мэдээ устгах</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                ...
                <div class="card card-custom gutter-b">
                      ...
                      <table class="table table-hover table-dark p-5 ">
                        ...
                        <?php $results_menu	 = mysqli_query($db, "SELECT * FROM news WHERE user = $user_id ");?>
                        <?php while ($row = mysqli_fetch_array($results_menu)) { ?>
                          <tr>
                            <td><?php echo $row['title_mon']; ?></td>
                            <td><?php echo $row['title_en']; ?></td>
                            <td><?php echo $row['time_s']; ?></td>
                            <td>
                              <a href="edit_news.php?edit_post=<?php echo $row['id']; ?>" class="edit_btn" ><i class="flaticon2-pen text-primary"></i></a>
                            </td>
                            <td>
                              <a href="../serverV1.php?del_post=<?php echo $row['id']; ?>" class="del_btn"><i class="flaticon-delete text-danger"></i></a>
                            </td>
                          </tr>
                        <?php } ?>
                      </table>
    ...
    <?php if(isset($_SESSION['alert_del'])){ unset($_SESSION['alert_del']); ?>
      Swal.fire("Ажилттай", "Мэдээ устсан", "success");
    <?php  } ?>
    <?php if(isset($_SESSION['alert'])){ unset($_SESSION['alert']); ?>
      Swal.fire("Ажилттай", "Мэдээ засварлагдлаа", "success");
    <?php  } ?>
		var d = new Date();
