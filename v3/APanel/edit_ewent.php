...
if(isset($_GET['edit_post'])){
  ...
  $post_row= mysqli_query($db, "SELECT * FROM ewent  where id='$fg_id' limit 1");
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                      ...
                      <li class="menu-item menu-item-active" aria-haspopup="true">
												<a href="#" class="menu-link">
													...
													<span class="menu-text">Мэдээлэл засвар</span>
												</a>
											</li>
                      <li class="menu-item " aria-haspopup="true">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Ewent засварлах</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                          ...
                          <input type="text" name="post_id" value="<?php echo $row_post['id']; ?>" hidden>
                            ...
                            <h1 class="text-center">English</h1>
                  					...
                  					<div class="form-group" style="position: relative;">
                  						...
                  						<textarea name="body_en" id="body_en" class="form-control" cols="30" rows="5" ><?php echo htmlspecialchars_decode($row_post['body_en']); ?></textarea>
                  					</div>
                          </div>
												</div>
                        <div class="input-group date mb-2">
                          <input type="text" class="form-control" placeholder="Дуусах хугцаа" id="kt_datetimepicker_4_1" name="end_time" value="<?php echo $row_post['end_time']; ?>">
                        </div>
                        <div class="form-group">
                  			...
                  			<div class="form-group">
                  				<button type="submit" class="btn btn-success" name="up-ewent">Шинэчилэх</button>
                  			</div>
												</form>
