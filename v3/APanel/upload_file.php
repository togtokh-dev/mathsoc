			...
			<div class="d-flex flex-row flex-column-fluid page">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Файл оруулах</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                ...
                <div class="row">
                      ...
                      <div class="form-group m-0">
  											<label>Төрөлөө сонгоно уу:</label>
                          ...
                          <div class="col-4">
  													<label class="option">
  														<span class="option-control">
  															<span class="radio">
  																<input type="radio" name="file_type" value="html" >
  																<span></span>
  															</span>
  														</span>
  														<span class="option-label">
                          ...
                          <div class="col-4">
  													<label class="option">
  														<span class="option-control">
  															<span class="radio">
  																<input type="radio" name="file_type" value="zip" checked="checked">
  																<span></span>
  															</span>
  														</span>
  														<span class="option-label">
                          ...
                          <div class="col-4">
  													<label class="option">
  														<span class="option-control">
  															<span class="radio">
  																<input type="radio" name="file_type" value="jpg" >
  																<span></span>
  															</span>
  														</span>
  														<span class="option-label">
                          ...
                          <div class="col-4">
  													<label class="option">
  														<span class="option-control">
  															<span class="radio">
  																<input type="radio" name="file_type" value="mp4" >
  																<span></span>
  															</span>
  														</span>
  														<span class="option-label">
                          ...
                          <div class="col-4">
  													<label class="option">
  														<span class="option-control">
  															<span class="radio">
  																<input type="radio" name="file_type" value="javascript" >
  																<span></span>
  															</span>
  														</span>
  														<span class="option-label">
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bg-light card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bold text-dark">Файл оруулах</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body pt-2">
												<!--begin::Form-->
													...
													<div class="form-group">
														...
														<input id="fileToUpload" name="fileToUpload" type="file" class="form-control-file" >
													</div>
