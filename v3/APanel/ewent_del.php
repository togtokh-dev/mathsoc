...
<html lang="en">
			...
			<div class="d-flex flex-row flex-column-fluid page">
                ...
                <div class="card card-custom gutter-b">
                      ...
                      <table class="table table-hover table-dark p-5 ">
                        ...
                        <?php $results_menu	 = mysqli_query($db, "SELECT * FROM ewent WHERE user = $user_id ");?>
                        <?php while ($row = mysqli_fetch_array($results_menu)) { ?>
                          <tr>
                            ...
                            <td>
                              <a href="edit_ewent.php?edit_post=<?php echo $row['id']; ?>" class="edit_btn" ><i class="flaticon2-pen text-primary"></i></a>
                            </td>
                            <td>
                              <a href="../serverV1.php?del_ewent=<?php echo $row['id']; ?>" class="del_btn"><i class="flaticon-delete text-danger"></i></a>
                            </td>
                          </tr>
                        <?php } ?>
                      </table>
    ...
    <?php if(isset($_SESSION['alert_del'])){ unset($_SESSION['alert_del']); ?>
      Swal.fire("Ажилттай", "Ewent устсан", "success");
    <?php  } ?>
    <?php if(isset($_SESSION['alert'])){ unset($_SESSION['alert']); ?>
      Swal.fire("Ажилттай", "Ewent засварлагдлаа", "success");
    <?php  } ?>
		var d = new Date();
