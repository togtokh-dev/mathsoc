...
<html lang="en">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Ewent оруулах</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                ...
                <div class="card card-custom gutter-b">
                            ...
                            <h1 class="text-center">Монгол</h1>
                  					<div class="form-group">
                  						...
                  						<input type="text" name="title_mon" class="form-control" >
                  					</div>
                  					<div class="form-group" style="position: relative;">
                  						<label for="post">Цогцолбор</label>
                  						<textarea name="body_mon" id="body_mon" class="form-control" cols="30" rows="5"></textarea>
                  					</div>
                          </div>
                            ...
                            <h1 class="text-center">English</h1>
                  					...
                  					<div class="form-group" style="position: relative;">
                  						...
                  						<textarea name="body_en" id="body_en" class="form-control" cols="30" rows="5"></textarea>
                  					</div>
                          </div>
												</div>
                        <div class="input-group date mb-2">
                          <input type="text" class="form-control" placeholder="Дуусах хугцаа" id="kt_datetimepicker_4_1" name="end_time">
                        </div>
                        <div class="form-group">
                  				<label for="title">Зурагны url</label>
                  				<input type="url" name="img" class="form-control" id="imageFile">
                  			</div>
                  			<div class="form-group">
                  				<button type="submit" class="btn btn-success" name="save-ewent">Оруулах</button>
                  			</div>
												</form>
    ...
    <?php if(isset($_SESSION['alert'])){ unset($_SESSION['alert']); ?>
      Swal.fire("Ажилттай", "Шинэ ewent нийтлэгдлээ", "success");
    <?php  } ?>
		var d = new Date();
