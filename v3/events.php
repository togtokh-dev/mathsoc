				...
				<div class="d-flex flex-column flex-row-fluid wrapper " id="kt_wrapper">
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $lang[$lan]['menu_val'][0]; ?></h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $lang[$lan]['menu_val'][0]; ?></a>
											<!--begin::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                  ...
                  <div class="col-lg-9 col-xl-9  pt-5">
										<div class="card card-custom sticky p-5">
											<h1><?php echo $lang[$lan]['news_e_a'][3]; ?></h1>
											<hr>
											<div class="row">
												<?php
										 		$results_per_page = 4;
										 		$sql='SELECT * FROM ewent ';
										 		...
										 		$sql='SELECT * FROM ewent  ORDER BY id DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
										 		$result = mysqli_query($db, $sql);
                          ...
                          <?php if($lan=='mon_name'){ ?>
										 		...
										 		<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url(<?php echo $row['photo']; ?>); height: 340px;">
										 			...
										 			<div class="card-body d-flex flex-column align-items-start justify-content-start">
										 				<div class="p-1 flex-grow-1">
															...
															<h5 class="text-warning font-weight-bolder line-height-lg mb-5 " id="time_r_id_<?php echo $row["id"]; ?>"></h5>
														</div>
										 				<a href="event.php?id=<?php echo $row['id']; ?>" class="btn btn-link btn-link-warning font-weight-bold"><?php echo $lang[$lan]['news_e_a'][1]; ?>
											...
											var countDownDate_<?php echo $row['id']; ?> = <?php  echo strtotime($row['end_time'] ) ?> * 1000;
										 ...
										 clearInterval(x_<?php echo $row['id']; ?>);
											document.getElementById("time_r_id_<?php echo $row["id"]; ?>").innerHTML = "Ewent completed";
										 }
                    ...
                    <?php }else{ ?>
                      <div class="col-xl-6">
                       ...
                       <!--end::Mixed Widget 14-->
										...
										var seconds_<?php echo $row['id']; ?> = Math.floor((distance_<?php echo $row['id']; ?> % (1000 * 60)) / 1000);
										// Output the result in an element with id="demo"
										document.getElementById("time_r_id_<?php echo $row["id"]; ?>").innerHTML = ""+days_<?php echo $row['id']; ?> + " days " + hours_<?php echo $row['id']; ?> + " hours " +
										minutes_<?php echo $row['id']; ?> + " minutes " + seconds_<?php echo $row['id']; ?> + " seconds ";
										// If the count down is over, write some text
										if (distance_<?php echo $row['id']; ?> < 0) {
										clearInterval(x_<?php echo $row['id']; ?>);
										 document.getElementById("time_r_id_<?php echo $row["id"]; ?>").innerHTML = "Ewent completed";
