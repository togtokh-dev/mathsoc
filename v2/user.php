...
<?php
  $user_row= mysqli_query($db, "SELECT * FROM users_1  where user_id='$on' limit 1");
  if(mysqli_num_rows($user_row)==1){
 ?>
 <?php while ($row_user = mysqli_fetch_array($user_row)) { ?>
<!DOCTYPE html>
<html lang="en">
	<!--begin::Head-->
	<head><base href="../">
		...
		<meta property="og:image"              content="<?php echo $row_user['photo']; ?>" />
		<!--begin::Fonts-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $row_user['username']; ?></h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $row_user['username']; ?></a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                ...
                <div class="row">
                  <div class="col-xl-4">
                    <div class="card card-custom">
  										...
  										<div class="card-body pt-15">
  											...
  											<div class="text-center mb-10">
  												<div class="symbol symbol-60 symbol-circle symbol-xl-90">
  													<div class="symbol-label" style="background-image:url('<?php echo $row_user['photo']; ?>')"></div>
  													<i class="symbol-badge symbol-badge-bottom bg-success"></i>
  												</div>
  												<h4 class="font-weight-bold my-2"><?php echo $row_user['username']; ?></h4>
  												<div class="text-muted mb-2"><?php
                          if($row_user['user_type']=='user'){
                            echo "Зочин";
                          }
                          if($row_user['user_type']=='co_user'){
                            echo "Хэрэглэгч";
                          }
                           if($row_user['user_type']=='admin'){
                            echo "Админ";
                          }
                           if($row_user['user_type']=='god'){
                            echo "Хөгжүүлэгч";
                          } ?></div>
  											</div>
  											<!--end::User-->
                          ...
                          <?php echo $row_user['fb_name']; ?>
  											</div>
  											<!--end::Contact-->
  											<!--begin::Nav-->
                        <?php if(tolson_in($row_user['end_date'])){
                          echo '	<a href="#" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block active">Гишүүнчлэлтэй</a>';
                        }else{
                          echo '<a href="#" class="btn btn-hover-light-danger font-weight-bold py-3 px-6 mb-2 text-center btn-block active">Гишүүнчлэлгүй</a>';
                        } ?>


  											<a href="#" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block">Нийт оруулсан мэдээлэл : <?php echo mysqli_num_rows(mysqli_query($db, "SELECT * FROM post  where user='$on' ")); ?></a>
  											<a href="#" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block">Нийт оруулсан бодлого : <?php echo mysqli_num_rows(mysqli_query($db, "SELECT * FROM math_7  where user='$on' "));  ?></a>
  											<a href="#" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block">Нийт илгээсэн бодлогийн хариу : <?php echo mysqli_num_rows(mysqli_query($db, "SELECT * FROM sent_math  where user_id='$on' "));  ?></a>
  											<!--end::Nav-->
  										</div>
  										<!--end::Body-->
  									</div>
