...
if(isset($_GET['del_post'])){
	$rt_id=$_GET['del_post'];
	mysqli_query($db, "DELETE FROM post WHERE id=$rt_id");
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <!--begin::Menu Nav-->
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Мэдээлэл</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                ...
                <div class=" gutter-b">
                    ...
                    <table class="table table-hover table-dark p-5 ">
                      ...
                      <?php $results_menu	 = mysqli_query($db, "SELECT * FROM post WHERE user = $user_id ");?>
                      <?php while ($row = mysqli_fetch_array($results_menu)) { ?>
                        <tr>
                          ...
                          <td>
                            <a href="del_math.php?edit_post=<?php echo $row['id']; ?>" class="edit_btn" ><i class="flaticon2-pen text-primary"></i></a>
                          </td>
                          <td>
                            <a href="?del_post=<?php echo $row['id']; ?>" class="del_btn"><i class="flaticon-delete text-danger"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
