							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Бодлого оруулах</h5>
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
                ...
                <div class="card card-custom gutter-b">
									<div class="">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home">
															...
															<span class="nav-text">Бодлого оруулах</span>
														</a>
													</li>
												</ul>
                  					...
                  					<div class="form-group" style="position: relative;">
                  						...
                  						<textarea name="body" id="body_mon" class="form-control" cols="30" rows="5"></textarea>
                  					</div>
                          </div>
												</div>
                  			<div class="form-group">
                  				<button type="submit" class="btn btn-success" name="save-math">Оруулах</button>
                  			</div>
												</form>
											</div>
										</div>
