      ...
      <div class="navi navi-spacer-x-0 pt-5">
        ...
        <a href="custom/apps/user/profile-2.html" class="navi-item px-8">
          <div class="navi-link">
            ...
            <div class="navi-text">
              <div class="font-weight-bold">Миний үйл ажиллагаа</div>
              <div class="text-muted">Миний хамрагдах үйлажилгаа</div>
            </div>
          </div>
        </a>
        <!--end::Item-->
        <!--begin::Item-->
        <a href="sent.php" class="navi-item px-8">
          <div class="navi-link">
            <div class="navi-icon mr-2">
              <i class="flaticon2-hourglass text-primary"></i>
            </div>
            <div class="navi-text">
              <div class="font-weight-bold">Миний даалгавар</div>
              <div class="text-muted">Сүүлийн бодлогийн илгээлт болон төслийн илгээлт</div>
            </div>
          </div>
        </a>
        <!--end::Item-->
...
<?php } else{ ?>
  ...
  <a class="topbar-item" href="login.php">
    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto active">
      <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">Нэвтрэх</span>
      <span class="symbol symbol-35">
