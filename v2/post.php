...
?>
<?php
  $post_row= mysqli_query($db, "SELECT * FROM post  where id='$on' limit 1");
...
<html lang="en">
    ...
    <meta property="fb:app_id"             content="467598577547586" />
		...
		<meta property="og:title"              content="<?php  echo $row_post['title_mon']; ?> " />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="<?php echo $actual_link; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php  echo $row_post['title_mon']; ?></a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                ...
                <div class="row" data-sticky-container="">
										...
										<div class="card card-custom gutter-b example example-compact " id="print_post">
											<div class="card-header ">
												<div class="card-title col-8">
													<h3 class="card-label text-center"> <?php  echo $row_post['title_mon']; ?>
													</h3>
												</div>
												<div class="col-3 p-5">
                        ...
                        <?php   echo htmlspecialchars_decode($row_post['body_mon']); ?>
                    	</div>
										</div>
        ...
        <a href="1">
  		...
  		<div class="d-flex flex-column flex-root">
            ...
            <!--begin::Content-->
  								...
  								<div class="d-flex align-items-center flex-wrap mr-2">
  									...
  									<div class="d-flex flex-column">
  										...
  										<div class="d-flex align-items-center font-weight-bold my-2">
  											...
  											<!--begin::Item-->
  											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
  											<a href="<?php echo $actual_link; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Үндсэн мэдээ</a>
  											<!--end::Item-->
  											<!--begin::Item-->
  											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
  											<a href="<?php echo $actual_link; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">404 мэдээлэл алга</a>
  											<!--end::Item-->
  										</div>
  										<!--end::Breadcrumb-->
  									</div>
                  ...
                  <div class="row" data-sticky-container="">
  									<div class="col-lg-6 col-xl-9 pt-5">
  										<div class="card card-custom gutter-b example example-compact h-100" id="print_post"  >
                        <?php
                        $bg = array('<div class="d-flex flex-column flex-root">
                          <!--begin::Error-->
                          <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url(assets/media/error/bg1.jpg);">
                            ...
                            <p class="font-size-h3 text-muted font-weight-normal">Мэдээлэл алга холбоосоо шалгана уу !</p>
                            <!--end::Content-->
                          </div>
                          <!--end::Error-->
                        </div>',
                        ...
                        '<div class="d-flex flex-column flex-root">
                          ...
                          <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(assets/media/error/bg5.jpg);">
                            ...
                            <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
                              ...
                              <p class="font-size-h3">Мэдээлэл алга холбоосоо шалгана уу !</p>
                            </div>
                            <!--end::Content-->
                          </div>
                          <!--end::Error-->
                        ...
                        '<div class="d-flex flex-column flex-root">
                          ...
                          <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(assets/media/error/bg6.jpg);">
                            ...
                            <div class="d-flex flex-column flex-row-fluid text-center">
                              ...
                              <p class="display-4 font-weight-bold text-white">Мэдээлэл алга холбоосоо шалгана уу !</p>
                            </div>
                            <!--end::Content-->
                          </div>
                          <!--end::Error-->
