							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Үндсэн мэдээ</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Үндсэн мэдээ</a>
											<!--end::Item-->
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Сүүлд нэмэгдсэн , үндсэн эхлэл</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="col-lg-9 col-xl-9  pt-5">
										<div id="carouselExampleCaptions" class="carousel slide pb-5" data-ride="carousel">
											...
											<div class="carousel-inner">
											 <?php $results = mysqli_query($db, "SELECT * FROM math_7 order by  id desc LIMIT 3"); $count=0;?>
                       <?php while ($row = mysqli_fetch_array($results)) {  ?>
												<div class="carousel-item  <?php if($count==0){echo "active"; } $count++?> ">
													<div class="card card-custom">
														<div class="card-header card-header-right ribbon ribbon-left">
											   			<div class="ribbon-target bg-success" style="top: 10px; left: -2px;"><?php echo $row['date_t']; ?></div>
															<div class="card-title">
																<span class="card-icon">
																	<i class="flaticon-questions-circular-button text-primary"></i>
																</span>
																<h3 class="card-label"><?php echo $row['title']; ?></h3>
															</div>
															<div class="card-toolbar">
																<a href="math/<?php echo $row['id']; ?>" class="btn btn-sm btn-icon btn-light-primary">
																	<i class="flaticon-edit"></i>
																</a>
															</div>
														</div>
														<div class="card-body scroll scroll-pull" data-scroll="true" data-wheel-propagation="true" style="height: 200px">
													 <?php echo htmlspecialchars_decode($row['body']); ?></div>
													</div>
												</div>
												<?php } ?>
											</div>
										</div>
										<div class="card card-custom sticky p-5">
											<h1>Мэдээ</h1>
											<hr>
											<div class="row">
												<?php
											 ...
											 <div class="col-xl-4">
										 		...
										 		<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url(<?php echo $row['photo']; ?>); height: 340px;">
										 			...
										 			<div class="card-body d-flex flex-column align-items-start justify-content-start">
										 				...
										 				<a href="post/<?php echo $row['id']; ?>" class="btn btn-link btn-link-warning font-weight-bold">Дэлгэрэнгүй
														...
														<div class="d-flex flex-wrp p-2 m-3 ">
																...
																if($sn-5<=0){
																	...
																	if($sn==1){
																		...
																		echo '<a href="'.($sn-1).'" class="btn btn-icon btn-sm btn-light-success mr-2 my-1"><i class="ki ki-bold-arrow-back icon-xs"></i></a>';
																	}

																}else{
																	$sn1= $sn-5;
																		echo '<a href="1" class="btn btn-icon btn-sm btn-light-success mr-2 my-1"><i class="ki ki-bold-double-arrow-back icon-xs"></i></a>';
																...
																for ($page=$sn1;$page<=$sn2;$page++) {
																	if($page==$sn){
																		...
																		echo '<a href="'.$page.'" class="btn btn-icon btn-sm border-0 btn-hover-success mr-2 my-1">'.$page.'</a>';
																	}
																...
																if($number_of_pages-5>$sn){
																	$sn2= $sn+5;
																	echo' <a href="'.($sn+1).'" class="btn btn-icon btn-sm btn-light-success mr-2 my-1"><i class="ki ki-bold-arrow-next icon-xs"></i></a>';
																	echo' <a href="'.$number_of_pages.'" class="btn btn-icon btn-sm btn-light-success mr-2 my-1"><i class="ki ki-bold-double-arrow-next icon-xs"></i></a>';
																}else{
																	$sn2 =$number_of_pages;
